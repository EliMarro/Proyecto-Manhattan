...
z1 = z.min()
z2 = z.max()
tensor1= tensor[z1:z2+1, :, y1:y2] # se recorta el tensor. En este caso no se recorta en el eje x
print(tensor1.shape)



#para conseguir un menor tamaño del tensor para dárselo a la red como alternativa a usar capas de tensorflow
...
a_ = 0.25*(a0 +a1+ a2+ a3) #se hace la media 
print(a_.shape)
